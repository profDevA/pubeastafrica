            ...
            if ( $show_buttons ) {
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . esc_url_raw( str_replace( '&settings-updated=true', '', $_SERVER['REQUEST_URI'] ) ) . '">'; // phpcs:ignore
                  ...
                  echo '<button type="submit" class="option-tree-ui-button button button-secondary left reset-settings" title="' . __( 'Reset Options', 'thevoux' ) . '">' . __( 'Reset Options', 'thevoux' ) . '</button>';
